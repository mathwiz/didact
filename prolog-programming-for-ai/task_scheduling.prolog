...
insert( S/A, [ T/B | L ], [ S/A, T/B | L ], F, F ) :-    % Tasks lists are ordered
    A =< B, !.
...
% Heuristic estimate of a partial schedule is based on an optimistic estimate of the
% final finishing time of this partial schedule extended by all the remaining
% waiting tasks.
